		...
		<div class="row pt-3">
			<div class="d-flex flex-row-reverse">
				<div class="bd-highlight d-none d-lg-block">
					<h5>
						<a href="/">Home&gt;</a><a href="/free/boardList">게시판&gt;</a><a href="/free/boardList">자유게시판</a>
					</h5>
				</div>
			</div>
		</div>
		<div class="row">
			<div class="col-lg-2 d-grid text-center" id="sideBox">
					...
					<div class="col d-grid">
						<button type="button" class="btn mb-1 d-block d-lg-none "data-bs-toggle="collapse" data-bs-target="#listCollapse" id="btnCol"><b>자유게시판</b></button>
					</div>
...
<!-- 			<div class="blank"></div>
			...
			<div class="col-lg-10 d- pt-4" id="box">
					...
					<c:forEach var="i" items="${list}">
						...
						<div class='navi mt-3 text-center'><a href=/free/boardList?cpage=${page-1}><-</a> ${navi } <a href=/free/boardList?cpage=${page+1}>-></a></div>
						<div class= "write"><button class="btn d-md-block mt-3" id="write">글쓰기</button></div>
				</div>
			</div>
		</div>
		<!-- footer -->
