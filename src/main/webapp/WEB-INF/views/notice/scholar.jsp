		...
		<div class="row pt-3">
			<div class="d-flex flex-row-reverse">
				<div class="bd-highlight d-none d-lg-block">
					<h5>
						<a href="/">Home&gt;</a><a href="/scholarList.notice?page=1">공지사항&gt;</a><a href="/scholarList.notice?page=1">장학공지</a>
					</h5>
				</div>
			</div>
			...
			<div class="row">
				...
				<div class="col-lg-10 d- pt-4" id="box">
					<div class="row">
						...
						<div class="col-12">
							<form action="/searchScholar.notice?page=1" method="post" class="row">
					...
					<c:forEach var="i" items="${list}">
						<div class="row" style="border-bottom: 1px solid black">
							...
							<div class="col-md-4 col-12 text-left"><a href="/scholarView.notice?seq=${i.n_seq}">${i.title}</a></div>
					...
					<nav aria-label="Page navigation example">
						<ul class="pagination justify-content-center mt-3" >
							<li class="page-item"><a class="page-link" href="/scholarList.notice?page=1" aria-label="Previous"> <span aria-hidden="true">&laquo;</span></a></li>
							<li class="page-item"><a class="page-link" href="/scholarList.notice?page=${page-1}"><span aria-hidden="true">&lt;</span></a></li>
						<c:set var="nav" value="${fn:split(navi,'/')}"></c:set>
						<c:forEach items="${nav}" var="i">
							<li class="page-item d-none d-md-block"><a class="page-link" href="/scholarList.notice?page=${i}">${i}</a></li>
						</c:forEach>
							<li class="page-item d-block d-md-none"><a class="page-link"><span>${page} / ${end}</span></a></li>
							<li class="page-item"><a class="page-link" href="/scholarList.notice?page=${page+1}"><span aria-hidden="true">&gt;</span></a></li>
							<li class="page-item"><a class="page-link" href="/scholarList.notice?page=${end}"aria-label="Next"> <span aria-hidden="true">&raquo;</span></a></li>
						</ul>
					</nav>
					</c:when>
					<c:otherwise>
					<nav aria-label="Page navigation example">
						<ul class="pagination justify-content-center mt-3" >
							<li class="page-item"><a class="page-link" href="/searchScholar.notice?page=1&category=${category}&content=${content}" aria-label="Previous"> <span aria-hidden="true">&laquo;</span></a></li>
							<li class="page-item"><a class="page-link" href="/searchScholar.notice?page=${page-1}&category=${category}&content=${content}"><span aria-hidden="true">&lt;</span></a></li>
						<c:set var="nav" value="${fn:split(navi,'/')}"></c:set>
						<c:forEach items="${nav}" var="i">
							<li class="page-item d-none d-md-block"><a class="page-link" href="/searchScholar.notice?page=${i}&category=${category}&content=${content}">${i}</a></li>
						</c:forEach>
							<li class="page-item d-block d-md-none"><a class="page-link"><span>${page} / ${end}</span></a></li>
							<li class="page-item"><a class="page-link" href="/searchScholar.notice?page=${page+1}&category=${category}&content=${content}"><span aria-hidden="true">&gt;</span></a></li>
							<li class="page-item"><a class="page-link" href="/searchScholar.notice?page=${end}&category=${category}&content=${content}"aria-label="Next"> <span aria-hidden="true">&raquo;</span></a></li>
						</ul>
					</nav>
					</c:otherwise>
					</c:choose>
