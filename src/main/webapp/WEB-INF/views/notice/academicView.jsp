			...
			<div class="row mb-5">
					...
					<div class="col d-grid">
						...
						<div class="collapse navbar-collapse" id="listCollapse" >
							<ul class="navbar-nav flex-column " id="nav-ul">
								...
								<li class="nav-item nav-li"><a class="nav-link active" href="/academicList.notice?page=1">학사공지</a>
								</li>
				...
				<div class="col-lg-10 " id="box">
					...
					<div class="row  p-3" style="border-top:1px solid black">
						...
						<div class="col-8 -md-10"><a href="/academicView.notice?seq=${dto2.n_seq}">${dto2.title}</a></div>
					</div>
					</c:if>
					<c:if test="${!empty dto3}">
					<div class="row  p-3" style="border-top:1px solid black">
						<div class="col-4 col-md-2 text-center"><img src="/img/down.png">이전글</div>
						<div class="col-8 col-md-10"><a href="/academicView.notice?seq=${dto3.n_seq}">${dto3.title}</a></div>
					</div>
					</c:if>
				</div>
			</div>
