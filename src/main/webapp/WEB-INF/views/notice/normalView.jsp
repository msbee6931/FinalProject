			...
			<div class="row mb-5">
				...
				<div class="col-lg-10 " id="box">
					...
					<div class="row mx-2" id="normalBox">
						<div class="col-12 col-md-2 p-2 text-center" style="border:1px solid black">첨부파일</div>
					...
					<div class="row  p-3" style="border-top:1px solid black">
						...
						<div class="col-8 col-md-10"><a href="/normalView.notice?seq=${dto3.n_seq}">${dto3.title}</a></div>
					</div>
					</c:if>
				</div>
			</div>
