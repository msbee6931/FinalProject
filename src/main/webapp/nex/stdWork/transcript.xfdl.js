(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new WebBrowser("WebBrowser00","119","1","1241",null,null,"37",null,null,null,null,this.Div00.form);
            obj.set_taborder("0");
            this.Div00.addChild(obj.name, obj);

            obj = new Button("Button00","12","11","100","25",null,null,null,null,null,null,this.Div00.form);
            obj.set_taborder("1");
            obj.set_text("pdf 저장");
