(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Static("sta_sSeq","89","99","100","30",null,null,null,null,null,null,this.div_Info.form);
            obj.set_taborder("12");
            obj.set_text("");
            obj.set_border("1px solid black");
            obj.set_padding("0px 0px 0px 5px");
            ...
            obj = new Button("btnClassSearch","129","364","60","25",null,null,null,null,null,null,this.div_Info.form);
            obj.set_taborder("16");
            obj.set_text("조회");
            this.div_Info.addChild(obj.name, obj);

            obj = new Static("sta_timeTable","14","419","110","30",null,null,null,null,null,null,this.div_Info.form);
            obj.set_taborder("17");
            obj.set_text("시간표 조회");
            obj.set_border("1px solid black");
            obj.set_textAlign("center");
            ...
            obj = new Button("classTime","129","419","60","30",null,null,null,null,null,null,this.div_Info.form);
            obj.set_taborder("18");
            obj.set_text("조회");
            this.div_Info.addChild(obj.name, obj);
            ...
            obj = new Combo("co_myDept","89","69","100","30",null,null,null,null,null,null,this.div_Info.form);
            obj.set_taborder("20");
            ...
            obj = new Grid("gr_basketList","210","325","860","220",null,null,null,null,null,null,this);
            obj.set_taborder("4");
