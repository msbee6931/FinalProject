(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<ColumnInfo><Column id=\"code\" type=\"STRING\" size=\"256\"/><Column id=\"name\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"code\">M</Col><Col id=\"name\">남</Col></Row><Row><Col id=\"code\">W</Col><Col id=\"name\">여</Col></Row></Rows>");
            this.addChild(obj.name, obj);


            obj = new Dataset("ds_students", this);
            obj.set_useclientlayout("true");
            obj._setContents("<ColumnInfo><Column id=\"s_seq\" type=\"INT\" size=\"256\"/><Column id=\"pw\" type=\"STRING\" size=\"256\"/><Column id=\"name\" type=\"STRING\" size=\"256\"/><Column id=\"secNumber\" type=\"STRING\" size=\"256\"/><Column id=\"email\" type=\"STRING\" size=\"256\"/><Column id=\"contact\" type=\"STRING\" size=\"256\"/><Column id=\"adress\" type=\"STRING\" size=\"256\"/><Column id=\"scholarship\" type=\"STRING\" size=\"256\"/><Column id=\"rest\" type=\"STRING\" size=\"256\"/><Column id=\"grade\" type=\"STRING\" size=\"256\"/><Column id=\"gender\" type=\"STRING\" size=\"256\"/><Column id=\"deptCode\" type=\"STRING\" size=\"256\"/><Column id=\"colCode\" type=\"STRING\" size=\"256\"/><Column id=\"colGrade\" type=\"STRING\" size=\"256\"/><Column id=\"classCode\" type=\"STRING\" size=\"256\"/><Column id=\"className\" type=\"STRING\" size=\"256\"/></ColumnInfo>");
            this.addChild(obj.name, obj);
            ...
            obj = new Grid("gr_classList","29","49","1022","181",null,null,null,null,null,null,this);
            obj.set_taborder("4");
            obj.set_binddataset("ds_class");
            obj.set_autofittype("col");
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"48\"/><Column size=\"90\"/><Column size=\"179\"/><Column size=\"59\"/><Column size=\"113\"/><Column size=\"68\"/><Column size=\"209\"/><Column size=\"103\"/><Column size=\"57\"/></Columns><Rows><Row size=\"24\" band=\"head\"/><Row size=\"24\"/></Rows><Band id=\"head\"><Cell text=\"번호\"/><Cell col=\"1\" text=\"이수구분\"/><Cell col=\"2\" text=\"과목명\"/><Cell col=\"3\" text=\"학년\"/><Cell col=\"4\" text=\"과목코드\"/><Cell col=\"5\" text=\"학점\"/><Cell col=\"6\" text=\"강의시간\"/><Cell col=\"7\" text=\"강의실\"/><Cell col=\"8\" text=\"인원수\"/></Band><Band id=\"body\"><Cell text=\"expr:currow+1\" textAlign=\"center\" cursor=\"pointer\"/><Cell col=\"1\" text=\"bind:classPart\" textAlign=\"center\" displaytype=\"combotext\" combodataset=\"gds_part\" combocodecol=\"id\" combodatacol=\"name\" cursor=\"pointer\"/><Cell col=\"2\" text=\"bind:className\" tooltiptext=\"상세보기\" textAlign=\"center\" cursor=\"pointer\" wordWrap=\"english\"/><Cell col=\"3\" text=\"bind:grade\" textAlign=\"center\" cursor=\"pointer\"/><Cell col=\"4\" text=\"bind:classSeq\" textAlign=\"center\" displaytype=\"mask\" maskeditformat=\"#########\" cursor=\"pointer\"/><Cell col=\"5\" text=\"bind:classPoint\" textAlign=\"center\" cursor=\"pointer\"/><Cell col=\"6\" text=\"bind:classTime\" textAlign=\"center\" wordWrap=\"english\" cursor=\"pointer\"/><Cell col=\"7\" text=\"bind:classRoom\" textAlign=\"center\" cursor=\"pointer\"/><Cell col=\"8\" text=\"bind:limit\" textAlign=\"center\" cursor=\"pointer\"/></Band></Format></Formats>");
            this.addChild(obj.name, obj);
            ...
            co_search_innerdataset._setContents("<ColumnInfo><Column id=\"codecolumn\" size=\"256\"/><Column id=\"datacolumn\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"codecolumn\">All</Col><Col id=\"datacolumn\">전체</Col></Row><Row><Col id=\"codecolumn\">className</Col><Col id=\"datacolumn\">과목명</Col></Row><Row><Col id=\"codecolumn\">classTime</Col><Col id=\"datacolumn\">강의시간</Col></Row><Row><Col id=\"codecolumn\">classRoom</Col><Col id=\"datacolumn\">강의실</Col></Row></Rows>");
            ...
            obj = new Grid("gr_students","30","260","1020","230",null,null,null,null,null,null,this);
            obj.set_taborder("10");
            obj.set_autofittype("col");
            obj.set_binddataset("ds_students");
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"93\"/><Column size=\"139\"/><Column size=\"80\"/><Column size=\"112\"/><Column size=\"81\"/><Column size=\"80\"/><Column size=\"122\"/><Column size=\"118\"/><Column size=\"50\"/></Columns><Rows><Row size=\"24\" band=\"head\"/><Row size=\"24\"/></Rows><Band id=\"head\"><Cell text=\"과목 코드\"/><Cell col=\"1\" text=\"과목명\"/><Cell col=\"2\" text=\"학번\"/><Cell col=\"3\" text=\"학과\"/><Cell col=\"4\" text=\"이름\"/><Cell col=\"5\" text=\"학년\"/><Cell col=\"6\" text=\"이메일\"/><Cell col=\"7\" text=\"전화번호\"/><Cell col=\"8\" text=\"성별\"/></Band><Band id=\"body\"><Cell textAlign=\"center\" displaytype=\"text\" text=\"bind:classCode\"/><Cell col=\"1\" textAlign=\"center\" text=\"bind:className\"/><Cell col=\"2\" text=\"bind:s_seq\" textAlign=\"center\" displaytype=\"text\"/><Cell col=\"3\" text=\"bind:deptCode\" displaytype=\"combotext\" combodataset=\"deptCode\" combocodecol=\"code\" combodatacol=\"name\" textAlign=\"center\"/><Cell col=\"4\" text=\"bind:name\" textAlign=\"center\"/><Cell col=\"5\" text=\"bind:colGrade\" textAlign=\"center\"/><Cell col=\"6\" text=\"bind:email\" textAlign=\"center\"/><Cell col=\"7\" text=\"bind:contact\" textAlign=\"center\"/><Cell col=\"8\" text=\"bind:gender\" displaytype=\"combotext\" textAlign=\"center\" combodataset=\"ds_gender\" combocodecol=\"code\" combodatacol=\"name\"/></Band></Format></Formats>");
            this.addChild(obj.name, obj);

            obj = new Static("Static01","30","230","80","30",null,null,null,null,null,null,this);
            obj.set_taborder("11");
            obj.set_text("학생 정보");
            this.addChild(obj.name, obj);
        ...
        // User Script
        this.registerScript("classStudent.xfdl", function() {
        this.objApp = nexacro.getApplication();
        this.classStudent_onload = function(obj,e)
        {
        ...
        this.fn_callback=function(sId,errCd,errMsg){
        	...
        	if(sId=="myClassList"){
        		...
        		for(var i=0; i<this.ds_students.getRowCount(); i++){
        			this.ds_students.setColumn(i,"classCode",classCode);
        			this.ds_students.setColumn(i,"className",className);
        		}
        	}
        }
        ...
        {
            this.addEventHandler("onload",this.classStudent_onload,this);
        ...
        this.loadIncludeScript("classStudent.xfdl");
