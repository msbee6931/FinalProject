(function()
{
    return function()
    {
        ...
        // User Script
        this.registerScript("requestEnlargement_pop.xfdl", function() {

        this.requestEnlargement_pop_onload = function(obj,e)
        {
        	var seq = this.parent.param1;
        	var login= this.parent.param2;
        	this.WebBrowser00.set_url("http://http://15.165.196.249/request/viewp?seq="+seq+"&login="+login);
        };
        ...
        this.loadIncludeScript("requestEnlargement_pop.xfdl");
