...
if (!nexacro.Dataset) {
	...
	nexacro.Date = function (year, month, day, hours, minutes, seconds, milliseconds) {
		if (nexacro._getDatasetRule() == "2.0") {
		...
		if (bsetfullyear) {
			if (year <= 99 && year >= 0) {
				...
				if (calc_year < 0) {
					if (nexacro._getDatasetRule() == "1.0") {
						...
						calc_year = 0;
						this.date.setFullYear(calc_year, month, day);
					}
				}
				else {
				...
				if (cur_year > 9999) {
					...
					if (nexacro._getDatasetRule() == "1.0") {
						...
						this.date.setFullYear(9999, month, day);
					}
				}
				else if (cur_year < 0) {
					this.date.setFullYear(0);
			...
			toDateFromText : function (value) {
				if (!nexacro.DataUtils._isValidPackedDate(value)) {
					...
					if (isNaN(date.valueOf())) {
						...
						return nexacro.DataUtils._toDate(date.getFullYear(), date.getMonth() + 1, date.getDate());
					}
				}
			...
			toDateTimeFromText : function (value) {
				if (!nexacro.DataUtils._isValidPackedDateTime(value)) {
					...
					if (isNaN(date.valueOf())) {
						...
						return nexacro.DataUtils._toDateTime(date.getFullYear(), date.getMonth() + 1, date.getDate(), date.getHours(), date.getMinutes(), date.getSeconds(), date.getMilliseconds());
					}
				}
	...
	_pDataset._compareValue = function (val1, val2, coltype) {
		var func = nexacro.Dataset.prototype._compareValue[nexacro._getDatasetRule()];
		if (func) {
			return func.call(this, val1, val2, coltype);
		}

		return;
	};

	_pDataset._compareValue["1.0"] = function (val1, val2, coltype) {
	...
	_pDataset._compareValue["2.0"] = function (val1, val2, coltype) {
		if (val1 != null && val2 != null) {
			if (coltype == 4 || coltype < 0) {
				if ((val1 instanceof nexacro.Decimal)) {
					if (val2 instanceof nexacro.Decimal) {
	...
	_pDataset._isInvalidValue = function (value, coltype) {
		var func = nexacro.Dataset.prototype._isInvalidValue[nexacro._getDatasetRule()];
		if (func) {
			return func.call(this, value, coltype);
		}

		return false;
	};

	_pDataset._isInvalidValue["1.0"] = function (value, coltype) {
		return false;
	};

	_pDataset._isInvalidValue["2.0"] = function (value, coltype) {
	...
	_pDataset._getSumValue = function (records, colidx, start, end, coltype) {
		var func = nexacro.Dataset.prototype._getSumValue[nexacro._getDatasetRule()];
		if (func) {
			return func.call(this, records, colidx, start, end, coltype);
		}

		return 0;
	};

	_pDataset._getSumValue["1.0"] = function (records, colidx, start, end, coltype) {
	...
	_pDataset._getSumValue["2.0"] = function (records, colidx, start, end, coltype) {
		if (coltype != 2 && coltype != 3 && coltype != 4) {
			return 0;
		}
		var sum;
	...
	_pDataset._getSumExpr = function (records, exprFn, start, end, args) {
		var func = nexacro.Dataset.prototype._getSumExpr[nexacro._getDatasetRule()];
		if (func) {
			return func.call(this, records, exprFn, start, end, args);
		}

		return 0;
	};

	_pDataset._getSumExpr["1.0"] = function (records, exprFn, start, end, args) {
		var sum = 0;
		var isdecimal = false;
		function __Expr_loopFn (i) {
			var rowRow = this.__getParsedRow(records[i]);
	...
	_pDataset._getSumExpr["2.0"] = function (records, exprFn, start, end, args) {
		var sum = 0;
		var isdecimal = false;
		function __Expr_loopFn (i) {
			var rowRow = this.__getParsedRow(records[i]);
	...
	_pDataset._getRowsSumValue = function (records, rows, colidx, coltype) {
		var func = nexacro.Dataset.prototype._getRowsSumValue[nexacro._getDatasetRule()];
		if (func) {
			return func.call(this, records, rows, colidx, coltype);
		}

		return 0;
	};

	_pDataset._getRowsSumValue["1.0"] = function (records, rows, colidx, coltype) {
		if (coltype != 2 && coltype != 3 && coltype != 4) {
			return 0;
		}
	...
	_pDataset._getRowsSumValue["2.0"] = function (records, rows, colidx, coltype) {
		if (coltype != 2 && coltype != 3 && coltype != 4) {
			return 0;
		}
	...
	_pDataset._getRowsSumExpr = function (records, rows, exprFn, args) {
		var func = nexacro.Dataset.prototype._getRowsSumExpr[nexacro._getDatasetRule()];
		if (func) {
			return func.call(this, records, rows, exprFn, args);
		}

		return 0;
	};

	_pDataset._getRowsSumExpr["1.0"] = function (records, rows, exprFn, args) {
		var sum = 0;
		var isdecimal = false;
		function __Expr_loopFn (i) {
			var idx = rows[i];
	...
	_pDataset._getRowsSumExpr["2.0"] = function (records, rows, exprFn, args) {
		var sum = 0;
		var isdecimal = false;
		function __Expr_loopFn (i) {
			var idx = rows[i];
	...
	_pDataset._getCaseSumValue = function (records, cmpFn, colidx, start, end, coltype, args) {
		var func = nexacro.Dataset.prototype._getCaseSumValue[nexacro._getDatasetRule()];
		if (func) {
			return func.call(this, records, cmpFn, colidx, start, end, coltype, args);
		}

		return 0;
	};

	_pDataset._getCaseSumValue["1.0"] = function (records, cmpFn, colidx, start, end, coltype, args) {
		if (coltype != 2 && coltype != 3 && coltype != 4) {
			return 0;
		}
	...
	_pDataset._getCaseSumValue["2.0"] = function (records, cmpFn, colidx, start, end, coltype, args) {
		if (coltype != 2 && coltype != 3 && coltype != 4) {
			return 0;
		}
	...
	_pDataset._getCaseSumExpr = function (records, cmpFn, colidx, start, end, coltype, args) {
		var func = nexacro.Dataset.prototype._getCaseSumExpr[nexacro._getDatasetRule()];
		if (func) {
			return func.call(this, records, cmpFn, colidx, start, end, coltype, args);
		}
	...
	_pDataset._getCaseSumExpr["1.0"] = function (records, cmpFn, valFn, start, end, cmpargs, valargs) {
		var sum = 0;
		var isdecimal = false;
		function __Expr_loopFn (i) {
			var rowRow = this.__getParsedRow(records[i]);
	...
	_pDataset._getCaseSumExpr["2.0"] = function (records, cmpFn, valFn, start, end, cmpargs, valargs) {
		var sum = 0;
		var isdecimal = false;
		function __Expr_loopFn (i) {
			var rowRow = this.__getParsedRow(records[i]);
	...
	_pDataset._getAvgValue = function (records, colidx, start, end, coltype, excludeNaN) {
		var func = nexacro.Dataset.prototype._getAvgValue[nexacro._getDatasetRule()];
		if (func) {
			return func.call(this, records, colidx, start, end, coltype, excludeNaN);
		}

		return 0;
	};

	_pDataset._getAvgValue["1.0"] = function (records, colidx, start, end, coltype, excludeNaN) {
		if (coltype != 2 && coltype != 3 && coltype != 4) {
			return 0;
		}
	...
	_pDataset._getAvgValue["2.0"] = function (records, colidx, start, end, coltype, excludeNaN) {
		if (coltype != 2 && coltype != 3 && coltype != 4) {
			return 0;
		}
	...
	_pDataset._getAvgExpr = function (records, exprFn, start, end, excludeNaN, args) {
		var func = nexacro.Dataset.prototype._getAvgExpr[nexacro._getDatasetRule()];
		if (func) {
			return func.call(this, records, exprFn, start, end, excludeNaN, args);
		}

		return 0;
	};

	_pDataset._getAvgExpr["1.0"] = function (records, exprFn, start, end, excludeNaN, args) {
		var cnt = 0;
		var sum = 0;
		var isdecimal = false;
		function __Expr_loopFn (i) {
	...
	_pDataset._getAvgExpr["2.0"] = function (records, exprFn, start, end, excludeNaN, args) {
		var cnt = 0;
		var sum = 0;
		var isdecimal = false;
		function __Expr_loopFn (i) {
	...
	_pDataset._getRowsAvgValue = function (records, rows, colidx, coltype, excludeNaN) {
		var func = nexacro.Dataset.prototype._getRowsAvgValue[nexacro._getDatasetRule()];
		if (func) {
			return func.call(this, records, rows, colidx, coltype, excludeNaN);
		}

		return 0;
	};

	_pDataset._getRowsAvgValue["1.0"] = function (records, rows, colidx, coltype, excludeNaN) {
		if (coltype != 2 && coltype != 3 && coltype != 4) {
			return 0;
		}
	...
	_pDataset._getRowsAvgValue["2.0"] = function (records, rows, colidx, coltype, excludeNaN) {
		if (coltype != 2 && coltype != 3 && coltype != 4) {
			return 0;
		}
	...
	_pDataset._getRowsAvgExpr = function (records, rows, exprFn, excludeNaN, args) {
		var func = nexacro.Dataset.prototype._getRowsAvgExpr[nexacro._getDatasetRule()];
		if (func) {
			return func.call(this, records, rows, exprFn, excludeNaN, args);
		}

		return 0;
	};

	_pDataset._getRowsAvgExpr["1.0"] = function (records, rows, exprFn, excludeNaN, args) {
		var cnt = 0;
		var sum = 0;
		var isdecimal = false;
		function __Expr_loopFn (i) {
	...
	_pDataset._getRowsAvgExpr["2.0"] = function (records, rows, exprFn, excludeNaN, args) {
		var cnt = 0;
		var sum = 0;
		var isdecimal = false;
		function __Expr_loopFn (i) {
	...
	_pDataset._getCountValue = function (records, colidx, start, end, coltype) {
		var func = nexacro.Dataset.prototype._getCountValue[nexacro._getDatasetRule()];
		if (func) {
			return func.call(this, records, colidx, start, end, coltype);
		}
	...
	_pDataset._getCountValue["1.0"] = function (records, colidx, start, end, coltype) {
		var cnt = 0;
		function __Value_loopFn (i) {
			var rowRow = this.__getParsedRow(records[i]);
			if (rowRow._rtype & 7) {
	...
	_pDataset._getCountValue["2.0"] = function (records, colidx, start, end, coltype) {
		var cnt = 0;
		function __Value_loopFn (i) {
			var rowRow = this.__getParsedRow(records[i]);
			if (rowRow._rtype & 7) {
				if (colidx < 0) {
					...
					var colval = rowRow[colidx];
					if (colval) {
						if (!((coltype == 5 || coltype == 6 || coltype == 7) && colval == "Invalid Date")) {
							cnt++;
						}
					}
					else {
	...
	_pDataset._getRowsCountValue = function (records, rows, colidx, coltype) {
		var func = nexacro.Dataset.prototype._getRowsCountValue[nexacro._getDatasetRule()];
		if (func) {
			return func.call(this, records, rows, colidx, coltype);
		}
	...
	_pDataset._getRowsCountValue["1.0"] = function (records, rows, colidx, coltype) {
		var cnt = 0;
		function __loopFn (i) {
			var idx = rows[i];
			var rowRow = this.__getParsedRow(records[idx]);
	...
	_pDataset._getRowsCountValue["2.0"] = function (records, rows, colidx, coltype) {
		var cnt = 0;
		function __loopFn (i) {
			var idx = rows[i];
			var rowRow = this.__getParsedRow(records[idx]);
			if (rowRow && (rowRow._rtype & 7)) {
				var colval = rowRow[colidx];
				if (colval) {
					if (!((coltype == 5 || coltype == 6 || coltype == 7) && colval.toString() == "Invalid Date")) {
						cnt++;
					}
				}
				else {
	...
	_pDataset._convertValueBySaveProp = function (v, savenan, saveinfinity, saveinvaliddate) {
		...
		if ((saveinvaliddate == "exclude") && (v instanceof nexacro.Date) && v == "Invalid Date") {
			v = undefined;
		}
