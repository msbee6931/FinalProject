...
if (!nexacro.ListBox) {
	...
	_pListBox.enablevaluevalidation = false;
	...
	_pListBox.set_enablevaluevalidation = function (v) {
		v = nexacro._toBoolean(v);
		if (this.enablevaluevalidation != v) {
			this.enablevaluevalidation = v;
		}
	};
