...
if (!nexacro.CellInfo) {
	...
	_pCellInfo.__parseDate = function (v, dFlag) {
		...
		if (!dateobj) {
			...
			dateobj = new nexacro.Date(dateobj.getFullYear(), dateobj.getMonth() + 1, dateobj.getDate(), dateobj.getHours(), dateobj.getMinutes(), dateobj.getSeconds(), dateobj.getMilliseconds());
		}
